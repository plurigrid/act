# Authors: Barton, PralbertEinstein
# watsup the market 📈
# ---
# deploy: true
# ---
...
MODEL_REVISION = "24d5326600203b53f6240cbddd62ee354a6c40d2"  # pin model revisions to prevent unexpected changes!
...
app = modal.App(
    f"safesurf", image=tensorrt_image
)
...
def main():
    questions = [
        ...
        "prove that 3-MATCH balanced ternary is only P-Hard while 3-MATCH binary is NP-hard"
    ]
...
@modal.web_endpoint(
    method="POST", label=f"safesurf", docs=True
)
